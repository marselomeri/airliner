...
/**
 * Test TO_InitApp(), fail init CDS table
 */
void Test_TO_InitApp_Fail_InitCDSTbl(void)
{
    int32 result = CFE_SUCCESS;
...
void Test_TO_AppMain_Nominal_Wakeup(void)
{
    /* The following will emulate behavior of receiving a SCH message to WAKEUP */
    Ut_CFE_SB_SetReturnCode(UT_CFE_SB_RCVMSG_INDEX, CFE_SUCCESS, 1);
    Ut_CFE_SB_SetReturnCode(UT_CFE_SB_GETMSGID_INDEX, TO_WAKEUP_MID, 1);
...
{
    UtTest_Add(Test_TO_InitEvent_Fail_Register, TO_Test_Setup, TO_Test_TearDown,
               "Test_TO_InitEvent_Fail_Register");

    UtTest_Add(Test_TO_InitPipe_Fail_CreateSCHPipe, TO_Test_Setup, TO_Test_TearDown,
               "Test_TO_InitPipe_Fail_CreateSCHPipe");
    UtTest_Add(Test_TO_InitPipe_Fail_SubscribeWakeup, TO_Test_Setup, TO_Test_TearDown,
               "Test_TO_InitPipe_Fail_SubscribeWakeup");
    UtTest_Add(Test_TO_InitPipe_Fail_SubscribeSendHK, TO_Test_Setup, TO_Test_TearDown,
               "Test_TO_InitPipe_Fail_SubscribeSendHK");
    UtTest_Add(Test_TO_InitPipe_Fail_CreateCMDPipe, TO_Test_Setup, TO_Test_TearDown,
               "Test_TO_InitPipe_Fail_CreateCMDPipe");
    UtTest_Add(Test_TO_InitPipe_Fail_SubscribeCMD, TO_Test_Setup, TO_Test_TearDown,
               "Test_TO_InitPipe_Fail_SubscribeCMD");
    UtTest_Add(Test_TO_InitPipe_Fail_CreateDATAPipe, TO_Test_Setup, TO_Test_TearDown,
               "Test_TO_InitPipe_Fail_CreateDATAPipe");

    UtTest_Add(Test_TO_InitData, TO_Test_Setup, TO_Test_TearDown,
               "Test_TO_InitData");

    UtTest_Add(Test_TO_InitApp_Fail_InitEvent, TO_Test_Setup, TO_Test_TearDown,
               "Test_TO_InitApp_Fail_InitEvent");
    UtTest_Add(Test_TO_InitApp_Fail_InitPipe, TO_Test_Setup, TO_Test_TearDown,
               "Test_TO_InitApp_Fail_InitPipe");
    UtTest_Add(Test_TO_InitApp_Fail_InitData, TO_Test_Setup, TO_Test_TearDown,
               "Test_TO_InitApp_Fail_InitData");
    UtTest_Add(Test_TO_InitApp_Fail_InitConfigTbl, TO_Test_Setup, TO_Test_TearDown,
               "Test_TO_InitApp_Fail_InitConfigTbl");
    UtTest_Add(Test_TO_InitApp_Fail_InitCDSTbl, TO_Test_Setup, TO_Test_TearDown,
               "Test_TO_InitApp_Fail_InitCDSTbl");
    UtTest_Add(Test_TO_InitApp_Nominal, TO_Test_Setup, TO_Test_TearDown,
               "Test_TO_InitApp_Nominal");

    UtTest_Add(Test_TO_CleanupCallback, TO_Test_Setup, TO_Test_TearDown,
               "Test_TO_CleanupCallback");

    UtTest_Add(Test_TO_AppMain_Fail_RegisterApp, TO_Test_Setup, TO_Test_TearDown,
               "Test_TO_AppMain_Fail_RegisterApp");
    UtTest_Add(Test_TO_AppMain_Fail_InitApp, TO_Test_Setup, TO_Test_TearDown,
               "Test_TO_AppMain_Fail_InitApp");
    UtTest_Add(Test_TO_AppMain_Fail_AcquireConfigPtrs, TO_Test_Setup, TO_Test_TearDown,
               "Test_TO_AppMain_Fail_AcquireConfigPtrs");
    UtTest_Add(Test_TO_AppMain_InvalidSchMessage, TO_Test_Setup, TO_Test_TearDown,
               "Test_TO_AppMain_InvalidSchMessage");
    UtTest_Add(Test_TO_AppMain_Nominal_SendHK, TO_Test_Setup, TO_Test_TearDown,
               "Test_TO_AppMain_Nominal_SendHK");
    UtTest_Add(Test_TO_AppMain_Nominal_Wakeup, TO_Test_Setup, TO_Test_TearDown,
               "Test_TO_AppMain_Nominal_Wakeup");
    UtTest_Add(Test_TO_AppMain_ProcessNewData_InvalidMsgID, TO_Test_Setup, TO_Test_TearDown,
