...
//				&TO_AppData.Config.OutputQueue.OSALQueueID,
//				QueueName,
...
//	if(idx < TO_MAX_CHANNELS)
//	{
//		if(TO_AppData.Config.OutputQueue.OSALQueueID !=0)
//		{
//			void *buffer;
//			uint32 bufferSize = 0;
...
{
//	TO_AppData.Config.OutputQueue.SentCount = 0;
//	TO_AppData.Config.OutputQueue.HighwaterMark = 0;
}
