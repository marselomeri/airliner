...
; Entry 2 - Invalid DataType and OperatorID
entry = entry + 1
...
; Entry 5 - Invalid Message ID
entry = entry + 1
$SC_$CPU_LC_WDT[entry].DataType = LC_DATA_UWORD_BE
$SC_$CPU_LC_WDT[entry].OperatorID = LC_OPER_GE
$SC_$CPU_LC_WDT[entry].MessageID = CFE_PLATFORM_SB_HIGHEST_VALID_MSGID + 1
...
s create_tbl_file_from_cvt(hostCPU,apid,"WDTTable3","lc_def_wdt3.tbl",tableName,startMnemonic,endMnemonic)

write ";*********************************************************************"
write ";  End procedure $SC_$CPU_lc_wdt3 "
write ";*********************************************************************"
ENDPROC
