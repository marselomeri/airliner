...
+===============================+====================================+==========================================+
| :hs:`HS_Default_AppMon_Tbl`   | :hs:'hs_amt.c'                     | :hs:`HS_AMTEntry_t::AppName`             |
+                               |                                    +------------------------------------------+
...
+-------------------------------+------------------------------------+------------------------------------------+
| :hs:`EventMon_Tbl`            | :hs:'hs_emt.c'                     | :hs:`HS_EMTEntry_t::AppName`             |
+                               |                                    +------------------------------------------+
...
+-------------------------------+------------------------------------+------------------------------------------+
| :hs:`MsgActs_Tbl`             | :hs:'hs_mat.c'                     | :hs:`HS_MATEntry_t::EnableState`         |
+                               |                                    +------------------------------------------+
|                               |                                    | hs:`HS_MATEntry_t::Cooldown`             |
+                               |                                    +------------------------------------------+
|                               |                                    | hs:`HS_MATEntry_t::Message`              |
+-------------------------------+------------------------------------+------------------------------------------+
| :hs:`ExeCount_Tbl`            | :hs:`hs_xct.c`                     | :hs:`HS_XCTEntry_t::ResourceName`        |
+                               |                                    +------------------------------------------+
