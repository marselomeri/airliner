...
SCH_MessageEntry_t SCH_DefaultMessageTable[SCH_MAX_MESSAGES] =
{
   ...
   { { SCH_FIX_HEADER(SCH_UNUSED_MID, 0, 0), 0 } },
   /* Command ID #50 */
   { { SCH_FIX_HEADER(MFAA_SEND_HK_MID, 0xC000, 0x0001), 0x0000 } },
   /* Command ID #51 */
   { { SCH_FIX_HEADER(MFAA_WAKEUP_MID, 0xC000, 0x0001), 0x0000 } },
   /* Command ID #52 */
   { { SCH_FIX_HEADER(SCH_UNUSED_MID, 0, 0), 0 } },
   /* Command ID #53 */
   { { SCH_FIX_HEADER(SCH_UNUSED_MID, 0, 0), 0 } },
   ...
   { { SCH_FIX_HEADER(SCH_UNUSED_MID, 0, 0), 0 } },
   /* Command ID #55 */
   { { SCH_FIX_HEADER(MFAB_SEND_HK_MID, 0xC000, 0x0001), 0x0000 } },
   /* Command ID #56 */
   { { SCH_FIX_HEADER(MFAB_WAKEUP_MID, 0xC000, 0x0001), 0x0000 } },
   /* Command ID #57 */
   { { SCH_FIX_HEADER(SCH_UNUSED_MID, 0, 0), 0 } },
   /* Command ID #58 */
   { { SCH_FIX_HEADER(SCH_UNUSED_MID, 0, 0), 0 } },
