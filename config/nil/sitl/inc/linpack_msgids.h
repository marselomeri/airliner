...
#ifndef LINPACK_MSGIDS_H
#define LINPACK_MSGIDS_H
...
/**
** \brief LINPACK application-specific command MID
*/
#define LINPACK_CMD_MID                 (0x18C0)

/**
** \brief Command for the application to send HK data
*/
#define LINPACK_SEND_HK_MID             (0x18C1)

/**
** \brief Wakeup command for the application to perform processing
*/
#define LINPACK_WAKEUP_MID              (0x18D0)

/**
** \brief Application-specific data output
*/
#define LINPACK_OUT_DATA_MID            (0x18D1)

/**
** \brief Application housekeeping telemetry data
*/
#define LINPACK_HK_TLM_MID              (0x08BB)
