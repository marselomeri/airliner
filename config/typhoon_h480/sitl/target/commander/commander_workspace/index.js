...
var CFDP = require( path.join( global.CDR_INSTALL_DIR, 'cfdp' ) );
...
var cfdp = new CFDP( global.CDR_WORKSPACE, `${global.CDR_WORKSPACE}/etc/cfdp-config.json` );
