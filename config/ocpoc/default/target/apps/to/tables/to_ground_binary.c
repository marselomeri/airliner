...
TO_ChannelTbl_t TO_ConfigTbl =
{
	...
	TO_OUTPUT_TYPE_BINARY,
	{
        ...
        {MPU9250_HK_TLM_MID,		      1,	TO_PQUEUE_MEDIUM_IDX},
        {MPU9250_DIAG_TLM_MID,		      1,	TO_PQUEUE_MEDIUM_IDX},
        ...
        {PX4_ACTUATOR_ARMED_MID,          1,    TO_PQUEUE_HIGH_IDX},
        {PX4_ACTUATOR_CONTROLS_0_MID,     1,    TO_PQUEUE_HIGH_IDX},
        {PX4_DISTANCE_SENSOR_MID,         1,    TO_PQUEUE_HIGH_IDX},
        {PX4_SENSOR_BARO_MID,             1,    TO_PQUEUE_HIGH_IDX},
        {PX4_SENSOR_MAG_MID,              1,    TO_PQUEUE_HIGH_IDX},
        {PX4_SENSOR_ACCEL_MID,            1,    TO_PQUEUE_HIGH_IDX},
        {PX4_SENSOR_GYRO_MID,             1,    TO_PQUEUE_HIGH_IDX},
        {PX4_GPS_DUMP_MID,                1,    TO_PQUEUE_HIGH_IDX},
        {PX4_GPS_INJECT_DATA_MID,         1,    TO_PQUEUE_HIGH_IDX},
        {MS5611_DIAG_TLM_MID,             1,    TO_PQUEUE_MEDIUM_IDX},
        {MS5611_DIAG_TLM_MID,             1,    TO_PQUEUE_MEDIUM_IDX},
        {PX4_ACTUATOR_CONTROLS_3_MID,     1,    TO_PQUEUE_HIGH_IDX},
        {PX4_AIRSPEED_MID,                1,    TO_PQUEUE_HIGH_IDX},
        {PX4_BATTERY_STATUS_MID,          1,    TO_PQUEUE_HIGH_IDX},
        {PX4_MANUAL_CONTROL_SETPOINT_MID, 1,    TO_PQUEUE_HIGH_IDX},
        {PX4_RC_CHANNELS_MID,             1,    TO_PQUEUE_HIGH_IDX},
        {PX4_SENSOR_COMBINED_MID,         1,    TO_PQUEUE_HIGH_IDX}
	},{
		/* Priority Queues */
