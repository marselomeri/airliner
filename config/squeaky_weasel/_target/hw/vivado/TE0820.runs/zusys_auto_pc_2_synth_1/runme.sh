...
HD_PWD='C:/TE0820/vivado/TE0820.runs/zusys_auto_pc_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zusys_auto_pc_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zusys_auto_pc_2.tcl
