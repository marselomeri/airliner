...
HD_PWD='C:/TE0820/vivado/TE0820.runs/zusys_rst_ps8_0_99M_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zusys_rst_ps8_0_99M_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zusys_rst_ps8_0_99M_1.tcl
