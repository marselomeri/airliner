...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_SLOT_3_INTF_TYPE {xilinx.com:interface:spi_rtl:1.0} \
 ] $system_ila_0
...
connect_bd_intf_net -intf_net [get_bd_intf_nets zynq_ultra_ps_e_0_IIC_1] [get_bd_intf_ports IIC_1_0] [get_bd_intf_pins system_ila_0/SLOT_0_IIC]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_SPI_0 [get_bd_intf_ports SPI_0_0] [get_bd_intf_pins zynq_ultra_ps_e_0/SPI_0]
connect_bd_intf_net -intf_net [get_bd_intf_nets zynq_ultra_ps_e_0_SPI_0] [get_bd_intf_ports SPI_0_0] [get_bd_intf_pins system_ila_0/SLOT_2_SPI]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_SPI_1 [get_bd_intf_ports SPI_1_0] [get_bd_intf_pins zynq_ultra_ps_e_0/SPI_1]
connect_bd_intf_net -intf_net [get_bd_intf_nets zynq_ultra_ps_e_0_SPI_1] [get_bd_intf_ports SPI_1_0] [get_bd_intf_pins system_ila_0/SLOT_3_SPI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets zynq_ultra_ps_e_0_UART_1] [get_bd_intf_ports UART_1_0] [get_bd_intf_pins system_ila_0/SLOT_1_UART]
