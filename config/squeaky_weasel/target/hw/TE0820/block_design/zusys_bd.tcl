catch {TE::UTILS::te_msg TE_BD-0 INFO "This block design tcl-file was generate with Trenz Electronic GmbH Board Part:trenz.biz:te0820_4ev_1i:part0:2.0, FPGA: xczu4ev-sfvc784-1-i at 2019-12-10T17:05:53."}
...
if { $list_projs eq "" } {
   ...
   set_property BOARD_PART trenz.biz:te0820_4ev_1i:part0:2.0 [current_project]
}
