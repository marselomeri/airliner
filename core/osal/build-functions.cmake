...
function(osal_set_blackbox_unit_test)
    ...
    psp_add_test(osal-bb-${TEST_NAME}
        ${VALGRIND_EXCLUSIONS}
        SOURCES
    	    ${PROJECT_SOURCE_DIR}/osal/ut_assert/src/utassert.c
    	    ${PROJECT_SOURCE_DIR}/osal/ut_assert/src/utlist.c
    	    ${PROJECT_SOURCE_DIR}/osal/ut_assert/src/utstubs.c
    	    ${PROJECT_SOURCE_DIR}/osal/ut_assert/src/uttest.c
    	    ${PROJECT_SOURCE_DIR}/osal/ut_assert/src/uttools.c
            ${PARSED_ARGS_OSAL_SOURCE}
            ${PSP_OSAL_UTASSERT_BSP_SRC}
            ${PROJECT_SOURCE_DIR}/osal/src/tests/${TEST_NAME}/${TEST_NAME}.c

        INCLUDES
            ${PROJECT_SOURCE_DIR}/osal/ut_assert/inc/
