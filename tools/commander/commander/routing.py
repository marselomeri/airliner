...
channel_routing = [
                    ...
                    route(u'websocket.connect', inst_connect, path='/di'),
                    route(u'websocket.receive', setDefaultInstance, path='/di'),
                    route(u'websocket.disconnect', inst_disconnect, path='/di'),
