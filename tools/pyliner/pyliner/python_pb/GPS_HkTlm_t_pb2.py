...
_GPS_HKTLM_T_PB = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='VehicleGpsMsg', full_name='GPS_HkTlm_t_pb.VehicleGpsMsg', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='TlmHeader', full_name='GPS_HkTlm_t_pb.TlmHeader', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='usCmdErrCnt', full_name='GPS_HkTlm_t_pb.usCmdErrCnt', index=2,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='usCmdCnt', full_name='GPS_HkTlm_t_pb.usCmdCnt', index=4,
