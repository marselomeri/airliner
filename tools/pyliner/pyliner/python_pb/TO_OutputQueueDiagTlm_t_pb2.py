...
# source: _py_TO_OutputQueueDiagTlm_t.proto
...
TO_OutputQueueDiagTlm_t_pb = _reflection.GeneratedProtocolMessageType('TO_OutputQueueDiagTlm_t_pb', (_message.Message,), dict(
  ...
  __module__ = '_py_TO_OutputQueueDiagTlm_t_pb2'
