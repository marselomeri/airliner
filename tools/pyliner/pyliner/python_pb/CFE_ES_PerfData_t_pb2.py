...
# source: _py_CFE_ES_PerfData_t.proto
...
CFE_ES_PerfDataEntry_t_pb = _reflection.GeneratedProtocolMessageType('CFE_ES_PerfDataEntry_t_pb', (_message.Message,), dict(
  ...
  __module__ = '_py_CFE_ES_PerfData_t_pb2'
