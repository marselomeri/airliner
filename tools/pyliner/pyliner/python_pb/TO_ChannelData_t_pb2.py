...
# source: _py_TO_ChannelData_t.proto
...
TO_OutputQueue_t_pb = _reflection.GeneratedProtocolMessageType('TO_OutputQueue_t_pb', (_message.Message,), dict(
  ...
  __module__ = '_py_TO_ChannelData_t_pb2'
