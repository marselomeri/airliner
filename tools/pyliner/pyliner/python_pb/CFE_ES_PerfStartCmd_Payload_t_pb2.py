...
# source: _py_CFE_ES_PerfStartCmd_Payload_t.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='_py_CFE_ES_PerfStartCmd_Payload_t.proto',
  package='',
  serialized_pb=_b('\n\'_py_CFE_ES_PerfStartCmd_Payload_t.proto\"7\n CFE_ES_PerfStartCmd_Payload_t_pb\x12\x13\n\x0bTriggerMode\x18\x01 \x02(\r')
)
...
CFE_ES_PerfStartCmd_Payload_t_pb = _reflection.GeneratedProtocolMessageType('CFE_ES_PerfStartCmd_Payload_t_pb', (_message.Message,), dict(
  ...
  __module__ = '_py_CFE_ES_PerfStartCmd_Payload_t_pb2'
