...
# source: _py_CFE_ES_QueryAllTasksCmd_Payload_t.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='_py_CFE_ES_QueryAllTasksCmd_Payload_t.proto',
  package='',
  serialized_pb=_b('\n+_py_CFE_ES_QueryAllTasksCmd_Payload_t.proto\"@\n$CFE_ES_QueryAllTasksCmd_Payload_t_pb\x12\x18\n\x10QueryAllFileName\x18\x01 \x03(\t')
)
...
CFE_ES_QueryAllTasksCmd_Payload_t_pb = _reflection.GeneratedProtocolMessageType('CFE_ES_QueryAllTasksCmd_Payload_t_pb', (_message.Message,), dict(
  ...
  __module__ = '_py_CFE_ES_QueryAllTasksCmd_Payload_t_pb2'
