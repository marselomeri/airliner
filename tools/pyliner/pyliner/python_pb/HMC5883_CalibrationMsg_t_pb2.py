...
_HMC5883_CALIBRATIONMSG_T_PB = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='y_scale', full_name='HMC5883_CalibrationMsg_t_pb.y_scale', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='y_scale_internal', full_name='HMC5883_CalibrationMsg_t_pb.y_scale_internal', index=1,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='z_scale', full_name='HMC5883_CalibrationMsg_t_pb.z_scale', index=9,
