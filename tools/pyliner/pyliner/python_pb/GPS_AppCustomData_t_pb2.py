...
_GPS_APPCUSTOMDATA_T_PB = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='Status', full_name='GPS_AppCustomData_t_pb.Status', index=0,
      number=1, type=13, cpp_type=3, label=2,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='Baud', full_name='GPS_AppCustomData_t_pb.Baud', index=1,
      number=2, type=13, cpp_type=3, label=2,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='StreamingTask', full_name='GPS_AppCustomData_t_pb.StreamingTask', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='GotPosllh', full_name='GPS_AppCustomData_t_pb.GotPosllh', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ContinueFlag', full_name='GPS_AppCustomData_t_pb.ContinueFlag', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='RateCountLatLon', full_name='GPS_AppCustomData_t_pb.RateCountLatLon', index=5,
      number=6, type=13, cpp_type=3, label=2,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='ParserStatus', full_name='GPS_AppCustomData_t_pb.ParserStatus', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='RateCountVel', full_name='GPS_AppCustomData_t_pb.RateCountVel', index=7,
      number=8, type=13, cpp_type=3, label=2,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='ChildTaskID', full_name='GPS_AppCustomData_t_pb.ChildTaskID', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='AckWaitingMsg', full_name='GPS_AppCustomData_t_pb.AckWaitingMsg', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='MutexSatInfo', full_name='GPS_AppCustomData_t_pb.MutexSatInfo', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='GpsSatInfoMsg', full_name='GPS_AppCustomData_t_pb.GpsSatInfoMsg', index=11,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='AckState', full_name='GPS_AppCustomData_t_pb.AckState', index=12,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='AckWaitingRcvd', full_name='GPS_AppCustomData_t_pb.AckWaitingRcvd', index=13,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='Priority', full_name='GPS_AppCustomData_t_pb.Priority', index=14,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='GotVelned', full_name='GPS_AppCustomData_t_pb.GotVelned', index=15,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='TaskFlags', full_name='GPS_AppCustomData_t_pb.TaskFlags', index=16,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='MutexPosition', full_name='GPS_AppCustomData_t_pb.MutexPosition', index=18,
...
_GPS_APPCUSTOMDATA_T_PB.fields_by_name['StreamingTask'].message_type = _CFE_ES_CHILDTASKMAINFUNCPTR_T_PB
