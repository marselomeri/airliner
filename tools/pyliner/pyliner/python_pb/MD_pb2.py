...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='_py_MD.proto',
  package='',
  serialized_pb=_b('\n\x0c_py_MD.proto\"\x81\x01\n\x05MD_pb\x12\x18\n\x10source_file_name\x18\x01 \x03(\t\x12\x16\n\x0e\x64\x65st_file_name\x18\x02 \x03(\t\x12\x1c\n\x14segmentation_control\x18\x03 \x02(\t\x12\x15\n\rfile_transfer\x18\x04 \x02(\t\x12\x11\n\tfile_size\x18\x05 \x02(\r')
)
...
_MD_PB = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='dest_file_name', full_name='MD_pb.dest_file_name', index=1,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='file_size', full_name='MD_pb.file_size', index=4,
