...
# source: _py_CFE_SB_SubRprtMsg_Payload_t.proto
...
CFE_SB_Qos_t_pb = _reflection.GeneratedProtocolMessageType('CFE_SB_Qos_t_pb', (_message.Message,), dict(
  ...
  __module__ = '_py_CFE_SB_SubRprtMsg_Payload_t_pb2'
