...
_GPS_CFG_PRT_T_PB = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='inProtoMask', full_name='GPS_CFG_PRT_t_pb.inProtoMask', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='flags', full_name='GPS_CFG_PRT_t_pb.flags', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='mode', full_name='GPS_CFG_PRT_t_pb.mode', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='reserved1', full_name='GPS_CFG_PRT_t_pb.reserved1', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='txReady', full_name='GPS_CFG_PRT_t_pb.txReady', index=7,
