...
# source: _py_LGC_CurrentValueTable_t.proto
...
_LGC_CURRENTVALUETABLE_T_PB = _descriptor.Descriptor(
  name='LGC_CurrentValueTable_t_pb',
  full_name='LGC_CurrentValueTable_t_pb',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='m_ManualControlSetpointMsg', full_name='LGC_CurrentValueTable_t_pb.m_ManualControlSetpointMsg', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='m_VehicleStatusMsg', full_name='LGC_CurrentValueTable_t_pb.m_VehicleStatusMsg', index=1,
...
_LGC_CURRENTVALUETABLE_T_PB.fields_by_name['m_ManualControlSetpointMsg'].message_type = _PX4_MANUALCONTROLSETPOINTMSG_T_PB
_LGC_CURRENTVALUETABLE_T_PB.fields_by_name['m_VehicleStatusMsg'].message_type = _PX4_VEHICLESTATUSMSG_T_PB
...
DESCRIPTOR.message_types_by_name['LGC_CurrentValueTable_t_pb'] = _LGC_CURRENTVALUETABLE_T_PB
...
PX4_ManualControlSetpointMsg_t_pb = _reflection.GeneratedProtocolMessageType('PX4_ManualControlSetpointMsg_t_pb', (_message.Message,), dict(
  ...
  __module__ = '_py_LGC_CurrentValueTable_t_pb2'
...
LGC_CurrentValueTable_t_pb = _reflection.GeneratedProtocolMessageType('LGC_CurrentValueTable_t_pb', (_message.Message,), dict(
  DESCRIPTOR = _LGC_CURRENTVALUETABLE_T_PB,
  __module__ = '_py_LGC_CurrentValueTable_t_pb2'
  # @@protoc_insertion_point(class_scope:LGC_CurrentValueTable_t_pb)
  ))
_sym_db.RegisterMessage(LGC_CurrentValueTable_t_pb)
