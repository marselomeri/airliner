...
# source: _py_CFE_ES_PerfStartCmd_t.proto
...
_CFE_ES_PERFSTARTCMD_T_PB = _descriptor.Descriptor(
  name='CFE_ES_PerfStartCmd_t_pb',
  full_name='CFE_ES_PerfStartCmd_t_pb',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='CmdHeader', full_name='CFE_ES_PerfStartCmd_t_pb.CmdHeader', index=1,
...
CFE_ES_PerfStartCmd_t_pb = _reflection.GeneratedProtocolMessageType('CFE_ES_PerfStartCmd_t_pb', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:CFE_ES_PerfStartCmd_t_pb)
  ))
_sym_db.RegisterMessage(CFE_ES_PerfStartCmd_t_pb)
