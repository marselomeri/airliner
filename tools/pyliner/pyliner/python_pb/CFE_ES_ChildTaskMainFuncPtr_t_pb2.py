...
# source: _py_CFE_ES_ChildTaskMainFuncPtr_t.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='_py_CFE_ES_ChildTaskMainFuncPtr_t.proto',
  package='',
  serialized_pb=_b('\n\'_py_CFE_ES_ChildTaskMainFuncPtr_t.proto\"I\n CFE_ES_ChildTaskMainFuncPtr_t_pb\x12%\n\x1d\x43\x46\x45_ES_ChildTaskMainFuncPtr_t\x18\x01 \x02(\r')
)
...
CFE_ES_ChildTaskMainFuncPtr_t_pb = _reflection.GeneratedProtocolMessageType('CFE_ES_ChildTaskMainFuncPtr_t_pb', (_message.Message,), dict(
  ...
  __module__ = '_py_CFE_ES_ChildTaskMainFuncPtr_t_pb2'
