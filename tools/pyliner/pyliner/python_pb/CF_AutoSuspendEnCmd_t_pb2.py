...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='',
  serialized_pb=_b('\n\x1f_py_CF_AutoSuspendEnCmd_t.proto\"D\n\x18\x43\x46_AutoSuspendEnCmd_t_pb\x12\x15\n\rEnableDisable\x18\x01 \x02(\r\x12\x11\n\tCmdHeader\x18\x02 \x03(\r')
)
...
_CF_AUTOSUSPENDENCMD_T_PB = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='EnableDisable', full_name='CF_AutoSuspendEnCmd_t_pb.EnableDisable', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='CmdHeader', full_name='CF_AutoSuspendEnCmd_t_pb.CmdHeader', index=1,
