...
# source: _py_CFE_TBL_Info_t.proto
...
_CFE_TBL_INFO_T_PB = _descriptor.Descriptor(
  name='CFE_TBL_Info_t_pb',
  full_name='CFE_TBL_Info_t_pb',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='UserDefAddr', full_name='CFE_TBL_Info_t_pb.UserDefAddr', index=0,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='FileCreateTimeSecs', full_name='CFE_TBL_Info_t_pb.FileCreateTimeSecs', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='DumpOnly', full_name='CFE_TBL_Info_t_pb.DumpOnly', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='FileCreateTimeSubSecs', full_name='CFE_TBL_Info_t_pb.FileCreateTimeSubSecs', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='TableLoadedOnce', full_name='CFE_TBL_Info_t_pb.TableLoadedOnce', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='Crc', full_name='CFE_TBL_Info_t_pb.Crc', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='Critical', full_name='CFE_TBL_Info_t_pb.Critical', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='DblBuffered', full_name='CFE_TBL_Info_t_pb.DblBuffered', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='NumUsers', full_name='CFE_TBL_Info_t_pb.NumUsers', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='Size', full_name='CFE_TBL_Info_t_pb.Size', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='TimeOfLastUpdate', full_name='CFE_TBL_Info_t_pb.TimeOfLastUpdate', index=11,
...
_CFE_TBL_INFO_T_PB.fields_by_name['TimeOfLastUpdate'].message_type = _CFE_TIME_SYSTIME_T_PB
DESCRIPTOR.message_types_by_name['CFE_TIME_SysTime_t_pb'] = _CFE_TIME_SYSTIME_T_PB
DESCRIPTOR.message_types_by_name['CFE_TBL_Info_t_pb'] = _CFE_TBL_INFO_T_PB
...
CFE_TIME_SysTime_t_pb = _reflection.GeneratedProtocolMessageType('CFE_TIME_SysTime_t_pb', (_message.Message,), dict(
  ...
  __module__ = '_py_CFE_TBL_Info_t_pb2'
  # @@protoc_insertion_point(class_scope:CFE_TIME_SysTime_t_pb)
  ))
_sym_db.RegisterMessage(CFE_TIME_SysTime_t_pb)

CFE_TBL_Info_t_pb = _reflection.GeneratedProtocolMessageType('CFE_TBL_Info_t_pb', (_message.Message,), dict(
  DESCRIPTOR = _CFE_TBL_INFO_T_PB,
  __module__ = '_py_CFE_TBL_Info_t_pb2'
  # @@protoc_insertion_point(class_scope:CFE_TBL_Info_t_pb)
  ))
_sym_db.RegisterMessage(CFE_TBL_Info_t_pb)
