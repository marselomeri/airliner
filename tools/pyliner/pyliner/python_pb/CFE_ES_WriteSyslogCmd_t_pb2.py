...
# source: _py_CFE_ES_WriteSyslogCmd_t.proto
...
_CFE_ES_WRITESYSLOGCMD_T_PB = _descriptor.Descriptor(
  name='CFE_ES_WriteSyslogCmd_t_pb',
  full_name='CFE_ES_WriteSyslogCmd_t_pb',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='Payload', full_name='CFE_ES_WriteSyslogCmd_t_pb.Payload', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='CmdHeader', full_name='CFE_ES_WriteSyslogCmd_t_pb.CmdHeader', index=1,
...
CFE_ES_WriteSyslogCmd_t_pb = _reflection.GeneratedProtocolMessageType('CFE_ES_WriteSyslogCmd_t_pb', (_message.Message,), dict(
  ...
  __module__ = '_py_CFE_ES_WriteSyslogCmd_t_pb2'
  # @@protoc_insertion_point(class_scope:CFE_ES_WriteSyslogCmd_t_pb)
  ))
_sym_db.RegisterMessage(CFE_ES_WriteSyslogCmd_t_pb)
