...
# source: _py_CF_TransPacket_t.proto
...
CF_EngTransStat_t_pb = _reflection.GeneratedProtocolMessageType('CF_EngTransStat_t_pb', (_message.Message,), dict(
  ...
  __module__ = '_py_CF_TransPacket_t_pb2'
