...
_PX4_POSITION_SETPOINT_PB = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='AZ', full_name='px4_position_setpoint_pb.AZ', index=19,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='AY', full_name='px4_position_setpoint_pb.AY', index=20,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='AX', full_name='px4_position_setpoint_pb.AX', index=21,
